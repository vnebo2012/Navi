...
public class Fun7Activity extends AppCompatActivity {
...
//endregion
    ...
    final String MY_SETTINGS = "saved_text_fun7";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fun7);
        ...
        my_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(Fun7Activity.this,MainActivity.class);
        ...
        boolean hasVisited = sp.getBoolean("hasVisited7", false);
...
// Стороны
              ...
              //  float num002 = Float.parseFloat(aetText2.getText().toString());
                ...
                float w = (float) ((float) ((num001 * 4) + (num003 * 3)) * ((num004 * 0.01)*(num005 * 0.01)));
...

                {
                    ...
                    float x = (float) (float) ((((((num001*4) + (num003*3))/num009)*p)));
                ...
                {
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (0.617))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                ...
                {
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (0.888))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                    float e = (float) (e1+(e1*num012/100));
                    float m = (float) (m1+(m1*num012/100));
                ...
                else if (Float.parseFloat(aetText7.getText().toString()) == 14)
                {
                    ...
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (1.210))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                    float e = (float) (e1+(e1*num012/100));
                    float m = (float) (m1+(m1*num012/100));
                ...
                else if (Float.parseFloat(aetText7.getText().toString()) == 16)
                {
                    ...
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (1.580))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                    float e = (float) (e1+(e1*num012/100));
                    float m = (float) (m1+(m1*num012/100));
                ...
                else if (Float.parseFloat(aetText7.getText().toString()) == 18)
                {
                    ...
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (2.000))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                    float e = (float) (e1+(e1*num012/100));
                    float m = (float) (m1+(m1*num012/100));
                ...
                {
                    float e1 = (float) (((float) (((num001 * 4) +(num003*3)) * (2.470))*num007));
                    float m1 = (float) (((float) (((num001 * 4) +(num003*3))*(num007))));
                    float e = (float) (e1+(e1*num012/100));
                    float m = (float) (m1+(m1*num012/100));
