...
public class Pris6Activity extends AppCompatActivity {
...
//endregion
    ...
    final String MY_SETTINGS = "saved_text_pris8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pris_8);
        ...
        my_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(Pris6Activity.this,MainActivity.class);
        ...
        boolean hasVisited = sp.getBoolean("hasVisitedPerim2", false);
        ...
        if (!hasVisited) {
            ...
            e.putBoolean("hasVisitedPerim2", true);
