...
public class Pris3Activity extends AppCompatActivity {
...
//endregion
    ...
    final String MY_SETTINGS = "saved_text_pris3";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pris_3);
        ...
        my_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(Pris3Activity.this,MainActivity.class);
        ...
        boolean hasVisited = sp.getBoolean("hasVisited13", false);
        ...
        if (!hasVisited) {
            ...
            e.putBoolean("hasVisited13", true);
