...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
       ...
       if (id == R.id.nav_gallery) {
           ...
           Intent intent = new Intent(MainActivity.this, HellpActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new TwoFragment(), "Фундамент");
        adapter.addFrag(new ThreeFragment(), "Достройка");
        adapter.addFrag(new ShetvertiyFragment(), "Стяжка");
        adapter.addFrag(new OneFragment(), "Колона");
