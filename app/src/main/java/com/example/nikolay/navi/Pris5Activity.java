...
public class Pris5Activity extends AppCompatActivity {
...
//endregion
    ...
    final String MY_SETTINGS = "saved_text_pris5";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pris_5);
        ...
        my_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(Pris5Activity.this,MainActivity.class);
        ...
        boolean hasVisited = sp.getBoolean("hasVisited131", false);
        ...
        if (!hasVisited) {
            ...
            e.putBoolean("hasVisited131", true);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button27);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button28);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button29);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button30);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button31);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button32);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button19);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button20);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button25);
                                                         ...
                                                         .setPositiveButton("OK",
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             TextView kpp41 = (TextView) findViewById(R.id.textViewWir12);


                                                                             Button kpp42 = (Button) findViewById(R.id.button26);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button33);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button34);
                                                                 ...
                                                                 new DialogInterface.OnClickListener() {
                                                                     public void onClick(DialogInterface dialog, int id) {
                                                                         ...
                                                                         if (userInput.getText().length() == 0)
                                                                         {
                                                                             ...
                                                                             Button kpp42 = (Button) findViewById(R.id.button35);
...
// Стороны
                ...
                float w = (float) ((float) ((num001) + (num002) + (num003)) * ((num004 * 0.01)*(num005 * 0.01)));
...

                {
                    ...
                    float x = (float) (float) (((((num001 + num002 + num003)/num009)*p)));
                ...
                {
                    float e1 = (float) (((float) (((num001 * 2) + (num002 * 2)+(num003*2)) * (0.617))*num007));
                    float m1 = (float) (((float) (((num001 * 2) + (num002 * 2)+(num003*2))*(num007))));
